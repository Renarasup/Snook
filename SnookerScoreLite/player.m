...
@synthesize hiBreakDate;
@synthesize hiBreak;
@synthesize trailBlazer;
@synthesize swappedPlayer;
@synthesize wonframes;
@synthesize playerWinsPC;
@synthesize playerMatchCount;
@synthesize playerMatchWins;
@synthesize playerMatchLosses;
@synthesize selectedPlayerWinsPC;
@synthesize selectedHiBreak;
@synthesize activeBreak;
@synthesize playerkey;
@synthesize hiBreakHistory;
@synthesize hbEver;
@synthesize hbFrame;
@synthesize hbMatch;
...
-(id)init {
    if ( self = [super init] ) {
        ...
        self.hbEver = [[hibreak alloc] init];
        ;
        self.hbMatch = [[hibreak alloc] init];
        ;
        self.hbFrame = [[hibreak alloc] init];
        ;
...
-(void) createCurrentFrame:(NSNumber *) value {
    ...
    currentFrame.frameIndex = [value intValue];
    currentFrame.frameScore = 0;
    currentFrame.frameHighestBreak = 0;
    currentFrameIndex = [value intValue];
